                           ...
                           <div class="page_title">
                            ...
                            //    print_r($row);
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <a href=" courses_update.php?updateid=<?=$row['c_id'];?>"><button class="btn btn-info">Edit</button></a>
                                    <a href="courses.php?deleteid=<?=$row['c_id'];?>"><button class="btn btn-danger" onclick="return confirm('Are You Sure')">Delete</button></a>
                                 </td>
                              </tr>
                              <?php
                               }
...
if(isset($_POST['c_title'])){    
   extract($_POST);  //Convert the string to the variable
    ...
    $query="INSERT INTO `courses`( `c_title`, `c_desc`, `c_price`, `c_type`, `c_duration`, `c_img`) 
    VALUES ('".$c_title."','".$c_desc."','".$c_price."','".$c_type."','".$c_duration."','".$c_img."')";
    $fire=mysqli_query($conn,$query);
    if($fire){
     echo "<script>alert('Succsess');window.location.href='courses.php'</script>";
    }
    else{
     echo "Error: ";
    }
...
if(isset($_GET['deleteid'])){
   ...
   $fire=mysqli_query($conn,$query);
   if($fire){
      echo "<script>alert('Successfully Delete');window.location.href='courses.php';</script>";
   }
   else{
      echo "Not Delete";
   }
