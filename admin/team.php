                           ...
                           <div class="page_title">
                             ...
                             <table class="table table-info table-bordered table-striped table-hover">
                              ...
                              <tr>
                                 ...
                                 <td><?=$row['i_link'];?></td>
                                 <td>
                                    <a href="teamupdate.php?updateid=<?=$row['team_id'];?>"><button class="btn btn-info">Edit</button></a>
                                    <a href="team.php?deleteid=<?=$row['team_id'];?>&img=<?=$row['team_img']?>"><button class="btn btn-danger" onclick="return confirm('Are You Sure')">Delete</button></a>
                                 </td>
                              </tr>
                              <?php
                               }
...
if(isset($_POST['team_name'])){
 ...
 $query="INSERT INTO team(team_name, team_Position, f_link, t_link, i_link, team_img) VALUES ('".$_POST['team_name']."','".$_POST['team_Position']."','".$_POST['f_link']."','".$_POST['t_link']."','".$_POST['i_link']."','".$team_img."')";
  ...
  $fire=mysqli_query($conn,$query);
  if($fire){
   echo "<script>alert('Succsess');window.location.href='team.php'</script>";
...
if(isset($_GET['deleteid'])){
   ...
   $fire=mysqli_query($conn,$query);
     if($fire){
       echo "<script>alert('Successfully Delete');window.location.href='team.php';</script>";
      }
     else{
      echo "Error";
     }
