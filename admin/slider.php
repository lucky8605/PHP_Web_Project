                           ...
                           <div class="page_title">
                             ...
                             <table class="table table-info table-bordered table-striped table-hover">
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <a href="sliderupdate.php?updateid=<?=$row['slider_id'];?>"><button class="btn btn-info">Edit</button></a>
                                    <a href="slider.php?deleteid=<?=$row['slider_id'];?>&img=<?=$row['slider_img']?>"><button class="btn btn-danger" onclick="return confirm('Are You Sure')">Delete</button></a>
                                 </td>
                              </tr>
                              <?php
                               }
...
// Data Insert In To The Database With Image
...
if(isset($_POST['slider_title'])){
 ...
 $query="INSERT INTO slider(slider_title,slider_img) VALUES ('".$_POST['slider_title']."','".$slider_img."')";
  ...
  $fire=mysqli_query($conn,$query);
  if($fire){
   echo "<script>alert('Succsess');window.location.href='slider.php'</script>";
...
if(isset($_GET['deleteid'])){
   ...
   $fire=mysqli_query($conn,$query);
     if($fire){
       echo "<script>alert('Successfully Delete');window.location.href='slider.php';</script>";
      }
     else{
      echo "Error";
     }
