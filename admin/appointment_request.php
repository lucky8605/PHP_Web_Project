                        ...
                        <div class="col-md-12">
                           <div class="page_title">
                             ...
                             <table class="table table-info table-bordered table-striped table-hover">
                              ...
                              <!-- Print Data In Table  -->
                              <?php
                               $query="SELECT * from appointment_list ORDER By a_id DESC";
                              ...
                              <tr>
                                 ...
                                 <td><?=$row['adate'];?></td>
                                 <td>
                                    <a href="appointment_request.php?id=<?=$row['a_id'];?>"><button class="btn btn-danger" onclick="return confirm('Are You Sure')">Delete</button></a>
                                 </td>
                              </tr>
                              <?php
                               }
...
if(isset($_GET['id'])){
    $query="DELETE from appointment_list where a_id='".$_GET['id']."'";
    $fire=mysqli_query($conn,$query);
    if($fire){
        echo "<script>alert('Succsessfully Delete');window.location.href='appointment_request.php'</script>";
