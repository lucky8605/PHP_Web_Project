                           ...
                           <div class="page_title">
                             ...
                             <table class="table table-info table-bordered table-striped table-hover">
                              ...
                              <tr>
                                 ...
                                 <td><?=$row['aw_title'];?></td>
                                 <td>
                                    <a href="about_update.php?updateid=<?=$row['aw_id'];?>"><button class="btn btn-info">Edit</button></a>
                                    <a href="about.php?deleteid=<?=$row['aw_id'];?>"><button class="btn btn-danger" onclick="return confirm('Are You Sure')">Delete</button></a>
                                 </td>
                              </tr>
                              <?php
                               }
...
if(isset($_POST['a_title'])){    
   ...
   $fire=mysqli_query($conn,$query);
   if($fire){
   echo "<script>alert('Succsess');window.location.href='about.php'</script>";
...
if(isset($_GET['deleteid'])){
   $query="DELETE FROM aw_details where aw_id='".$_GET['deleteid']."'";

   $fire=mysqli_query($conn,$query);
   if($fire){
      echo "<script>alert('Successfully Delete');window.location.href='about.php';</script>";
   }
   else{
      echo "Not Delete";
   }
