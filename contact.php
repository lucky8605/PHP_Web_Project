...
// print_r($_POST); 
if(isset($_POST['name'])){
    $query="INSERT INTO contact_data( name, email, subject, message, cdate) 
        VALUES ('".$_POST['name']."','".$_POST['email']."','".$_POST['subject']."','".$_POST['message']."','".date('Y-m-d')."')";

        $fire=mysqli_query($conn,$query);
        if($fire){
            echo "<script>alert('SuccessFully Send message');window.location.href='contact.php';</script>";
        }
        else{
            echo "Not Send";
        }
